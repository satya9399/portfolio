          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <div className="h-48 bg-gradient-to-r from-blue-400 to-blue-600 flex items-center justify-center">
                <span className="text-white font-bold text-xl">E-Commerce Website</span>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2">Online Store</h3>
                <p className="text-slate-600">A modern e-commerce platform built with Next.js and Stripe integration.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <div className="h-48 bg-gradient-to-r from-green-400 to-green-600 flex items-center justify-center">
                <span className="text-white font-bold text-xl">Task Management App</span>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2">Productivity Tool</h3>
                <p className="text-slate-600">A task management application with drag-and-drop functionality.</p>
              </div>
            </div>
