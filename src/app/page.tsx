        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="md:w-1/2 text-center md:text-left animate-fadeIn">
            ...
            <div className="flex gap-4 mt-8 justify-center md:justify-start">
              <a href="https://github.com/satya9399" target="_blank" rel="noopener noreferrer" className="text-slate-600 hover:text-blue-600 transition-colors">
              ...
              <a href="https://www.linkedin.com/in/satyam922" target="_blank" rel="noopener noreferrer" className="text-slate-600 hover:text-blue-600 transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
